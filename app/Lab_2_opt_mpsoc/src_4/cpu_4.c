...
#define RGB_IMAGE_BASE SHARED_ONCHIP_BASE+2304
#define GRAYSCALE_IMAGE_BASE SHARED_ONCHIP_BASE+4864
#define RESIZED_IMAGE_BASE SHARED_ONCHIP_BASE+5312
#define ASCII_IMAGE_BASE SHARED_ONCHIP_BASE+6336

#define LOPE_START 24
#define LOPE_END 32
...
int main()
{
	...
	if (IORD_8DIRECT(SEMAPHORE_2,CPU_OFFSET)&&IORD_8DIRECT(SEMAPHORE_4,CPU_OFFSET))
	{
	    ...
	    #if FINISH_INFO==1
	    alt_putstr("CPU_4 GS is finished!\n");
	    #endif
	}
	...
	if (IORD_8DIRECT(SEMAPHORE_3,CPU_OFFSET)&&IORD_32DIRECT(SEMAPHORE_8,CPU_OFFSET))
	{
	    ...
	    #if FINISH_INFO==1
	    alt_putstr("CPU_4 RS is finished!\n");
	    #endif
...
// 	    #if FINISH_INFO==1
// 	    alt_putstr("CPU_4 is Sobel finished!\n");
// 	    #endif
// 	}
    }
    #endif
