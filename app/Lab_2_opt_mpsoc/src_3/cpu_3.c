...
#define RGB_IMAGE_BASE SHARED_ONCHIP_BASE+1536
#define GRAYSCALE_IMAGE_BASE SHARED_ONCHIP_BASE+4608
#define RESIZED_IMAGE_BASE SHARED_ONCHIP_BASE+5248
#define ASCII_IMAGE_BASE SHARED_ONCHIP_BASE+6272

#define LOPE_START 16
#define LOPE_END 24
...
int main()
{
	...
	if (IORD_8DIRECT(SEMAPHORE_2,CPU_OFFSET)&&IORD_8DIRECT(SEMAPHORE_4,CPU_OFFSET))
	{
	    ...
	    #if FINISH_INFO==1
	    alt_putstr("CPU_3 GS is finished!\n");
	    #endif
	}
	...
	if (IORD_8DIRECT(SEMAPHORE_3,CPU_OFFSET)&&IORD_8DIRECT(SEMAPHORE_8,CPU_OFFSET))
	{
	    ...
	    #if FINISH_INFO==1
	    alt_putstr("CPU_3 RS is finished!\n");
	    #endif
...
// 	    #if FINISH_INFO==1
// 	    alt_putstr("CPU_3 Sobel is finished!\n");
// 	    #endif
// 	}
    }
    #endif
